...
python retro/U-2-Net/setup_model_weights.py
python -c 'import gdown; gdown.download("https://drive.google.com/uc?id=1nV57qKuy--d5u1yvkng9aXW1KS4sOpOi", "isnet-general-use.pth")'
